...
critical_columns=("total_cnf_price" "booking_requested" "invoice_confirmed" "consignee" "vessel" "shipment_size" "CC" "shift" "WD" "auction_house" "tax_total" "venue_id" "is_package_mode" "car_pictures")
missing_columns=()
