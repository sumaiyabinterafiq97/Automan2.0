...
docker-compose -f docker/docker-compose.multiplatform.yml down 2>/dev/null || true
...
if [ $? -eq 0 ]; then
    ...
    echo "   • Stop: docker-compose -f docker/docker-compose.multiplatform.yml down"
    echo "   • Restart: docker-compose -f docker/docker-compose.multiplatform.yml restart"
    echo "   • Logs: docker-compose -f docker/docker-compose.multiplatform.yml logs"
    echo "   • Remove: docker-compose -f docker/docker-compose.multiplatform.yml down -v"
    echo ""
    echo "🔍 Verify Setup:"
