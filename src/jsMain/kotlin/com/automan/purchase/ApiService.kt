...
object ApiService {
    ...
    suspend fun fetchPurchases(): List<Purchase> {
        ...
        return apiPurchases.map { apiPurchase ->
            Purchase(
                ...
                pol = apiPurchase.pol,
                pod = apiPurchase.pod ?: apiPurchase.destination,
                ...
                vessel = apiPurchase.vessel,
                destination = apiPurchase.destination ?: apiPurchase.pod,
    ...
    suspend fun createPurchase(purchase: Purchase): Purchase {
        val apiPurchase = ApiPurchase(
            ...
            pol = purchase.pol,
            pod = purchase.pod ?: purchase.destination,
            ...
            blNo = purchase.blNo,
            vessel = purchase.vessel,
            destination = purchase.destination ?: purchase.pod,
        ...
        return Purchase(
            ...
            pol = created.pol,
            pod = created.pod ?: created.destination,
            ...
            destination = created.destination ?: created.pod,
    ...
    suspend fun updatePurchase(purchase: Purchase): Purchase {
        ...
        return Purchase(
            ...
            pol = updated.pol,
            pod = updated.pod ?: updated.destination,
            ...
            destination = updated.destination ?: updated.pod,
